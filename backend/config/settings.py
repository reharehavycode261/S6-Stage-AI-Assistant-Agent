...
class Settings(BaseSettings):
    ...
    model_config = {
        "env_file": [
            ...
            Path(__file__).parent.parent / ".env",          # Dossier backend
            ".env"                                           # Dossier courant
        ],
    ...
    monday_client_id: Optional[str] = Field(default=None, env="MONDAY_CLIENT_ID")
    monday_client_key: Optional[str] = Field(default=None, env="MONDAY_CLIENT_KEY") 
    monday_app_id: Optional[str] = Field(default=None, env="MONDAY_APP_ID")
    
    monday_api_token: Optional[str] = Field(default=None, env="MONDAY_API_TOKEN")

    webhook_secret: str = Field(default="dev_webhook_secret_change_me", env="WEBHOOK_SECRET")
    ...
    monday_board_id: Optional[str] = Field(default=None, env="MONDAY_BOARD_ID")
    monday_task_column_id: Optional[str] = Field(default=None, env="MONDAY_TASK_COLUMN_ID") 
    monday_status_column_id: Optional[str] = Field(default=None, env="MONDAY_STATUS_COLUMN_ID")
    ...
    secret_key: str = Field(default="dev_secret_key_change_me_in_production", env="SECRET_KEY")
